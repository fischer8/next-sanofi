    ...
    <section className="absolute z-20 top-0 bottom-0 w-full md:bg-opacity-50 flex items-center align-middle md:bg-black">
      <section className="absolute top-0 bottom-0 md:static w-full md:w-5/6 md:py-24 md:border rounded md:mx-auto bg-white flex flex-col items-center justify-center">
        ...
        <section className="flex flex-col lg:flex-row text-center w-5/6 h-54 mb-5">
          <section className="flex flex-col me-1 justify-evenly w-full bg-blue-100 border rounded p-5 lg:w-2/6">
            <p className="mb-2 font-bold">{'<1 Risco Muito Baixo'}</p>
            <p className="text-sm">Deambulação precoce</p>
          </section>
          <section className="flex flex-col me-1 justify-evenly w-full bg-blue-200 border rounded p-5 lg:w-2/6">
            <p className="mb-2 font-bold">1-2 Risco Baixo</p>
            <p className="text-sm">Profilaxia mecânica (CPI)</p>
          </section>
          <section className="flex flex-col me-1 justify-evenly w-full bg-orange-200 border rounded p-5 lg:w-2/6">
            <p className="mb-2 font-bold">3-4 Risco Moderado</p>
            <p className="text-sm">Profilaxia farmacológica (HNF ou HBPM)</p>
          </section>
          <section className="flex flex-col me-1 justify-evenly w-full bg-red-200 border rounded p-5 lg:w-2/6">
